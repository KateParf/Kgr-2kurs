...
for fa in f:
   ...
   x1, y1, z1 = 5000*v[v1-1][0] + 500, 5000*v[v1-1][1] + 300, 5000*v[v1-1][2] + 300
   x2, y2, z2 = 5000*v[v2-1][0] + 500, 5000*v[v2-1][1] + 300, 5000*v[v2-1][2] + 300
   x3, y3, z3 = 5000*v[v3-1][0] + 500, 5000*v[v3-1][1] + 300, 5000*v[v3-1][2] + 300
